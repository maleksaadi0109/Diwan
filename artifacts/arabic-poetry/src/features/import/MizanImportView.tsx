        ...
        <div className="p-5 bg-charcoal-900 rounded-2xl border border-white/5 space-y-4 animate-fadeIn select-text">
          <div className="flex items-start justify-between">
            ...
            <button
              ...
              disabled={isSaving}
              className="px-5 py-2.5 rounded-2xl bg-accent-700 hover:bg-accent-600 text-charcoal-950 font-bold text-xs transition-colors shadow-md flex items-center gap-1.5"
            >
          ...
          {isEnriching && (
            <div className="p-3 bg-charcoal-850 rounded-2xl border border-white/5 space-y-1.5 animate-fadeIn">
              ...
              <div className="w-full bg-charcoal-800 rounded-2xl h-1.5 overflow-hidden">
                <div
                  className="bg-accent-700 h-full rounded-2xl transition-all duration-300"
